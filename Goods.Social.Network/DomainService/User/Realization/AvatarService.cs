...
namespace Goods.System.Social.Network.DomainServices.Interface
{
    public class AvatarService : IAvatarService
    {
        ...
        public AvatarService(IEnumerable<IPhotoRepository> photoRepositoies, ILogger<GalleryService> logger, IValidator<int> idValidator)
        {
            _logger = logger;
        ...
        public async Task CreateAsync(IFormFile image, int userId)
        {
            ...
            await _photoRepositoies.FirstOrDefault(p => p.FileRepository == FileRepositoryEnum.Avatar).CreateAsync(image, userId);
        }
        ...
        public void Delete(int userId)
        {
            ...
            _photoRepositoies.FirstOrDefault(p => p.FileRepository == FileRepositoryEnum.Avatar).Delete(userId);
        }
        ...
        public string Get(int userId)
        {
            ...
            return _photoRepositoies.FirstOrDefault(p => p.FileRepository == FileRepositoryEnum.Avatar).Get(userId);
        }
        ...
        public async Task UpdateAsync(IFormFile image, int userId)
        {
            ...
            await _photoRepositoies.FirstOrDefault(p => p.FileRepository == FileRepositoryEnum.Avatar).UpdateAsync(image, userId);
        }
    }
}